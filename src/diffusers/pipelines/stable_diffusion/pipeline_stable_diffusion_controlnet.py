...
class StableDiffusionControlNetPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        #print("image.shape=", image.shape, "latents.shape=", latents.shape, " prompt_embeds.shape=", prompt_embeds.shape)
    ...
    def debug(
        ...
        #print("image.shape=",image.shape, " do guidance=", do_classifier_free_guidance)
